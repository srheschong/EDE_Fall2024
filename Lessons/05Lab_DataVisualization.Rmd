...
surface_temp_1999_plot + 
  ...
  labs(color='Lake') + #(changes name of column on plot)
  theme_wsj()
```
...
#   labs(temperature_C='Surface Temperature') *my attempt
...
# Change the color palette to magma and play with direction (+- 1), which one makes more sense? -1

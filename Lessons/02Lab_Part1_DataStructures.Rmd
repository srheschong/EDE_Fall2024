...
vector3 <- c(TRUE,TRUE,TRUE,FALSE,TRUE,FALSE) # Vector type:Logic elements
vector3
```
...
# Returns maximum number in vector
max(vector1)

#Create another vector of the values 10 thru 15
vector4 <- c(10:15)

# Combines items in vector1 and vector4
c(vector1, vector4)

# Multiplies the items one by one in both vectors
vector1 * vector4

# Multiplies all items in vector1 by 10
vector1 * 10

# Converts items in vector2 to all uppercase
toupper(vector2) 

# Returns the opposite of items in vector3
!vector3
